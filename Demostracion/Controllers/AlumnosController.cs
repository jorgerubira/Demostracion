...
namespace Demostracion.Controllers
{
    public class AlumnosController : Controller
    {
        ...
        public AlumnosController(Contexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre")] Alumno alumno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre")] Alumno alumno)
        {
            if (id != alumno.Id)
            {
                return NotFound();
